...
def extr():
    ...
    y1=np.genfromtxt(Dateiname,skip_header=1,usecols=(2),delimiter=",")
    y2=np.genfromtxt(Dateiname,skip_header=1,usecols=(3),delimiter=",")
    y3=np.genfromtxt(Dateiname,skip_header=1,usecols=(3),delimiter=",")
    y4=np.genfromtxt(Dateiname,skip_header=1,usecols=(3),delimiter=",")
...
fig.canvas.manager.set_window_title("TK-Pressure")
...
ax.set_ylabel("Pressure mbar]", color="#000000")
...
try:
    while True:
        try:
            ...
            d.close
            x=np.genfromtxt(Dateiname,skip_header=1,usecols=(6),delimiter=",")
            y1=np.genfromtxt(Dateiname,skip_header=1,usecols=(12),delimiter=",")
            y2=np.genfromtxt(Dateiname,skip_header=1,usecols=(13),delimiter=",")
            y3=np.genfromtxt(Dateiname,skip_header=1,usecols=(14),delimiter=",")
            y4=np.genfromtxt(Dateiname,skip_header=1,usecols=(15),delimiter=",")
            y5=np.genfromtxt(Dateiname,skip_header=1,usecols=(16),delimiter=",")
